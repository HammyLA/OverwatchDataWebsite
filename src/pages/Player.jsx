...
function Player() {
  ...
  if (!data || !average) {
    ...
    console.log(data.competitive.pc);
    ...
    return (
      <div className="min-100">
        <div class="container text-center border border-light bg-dark rounded my-5">
          <div class="row">
            <div class="col-sm-8">
              <div
          ...
          <div class="row">
            <div class="col-sm">
              <h2 className="border border-light rounded">
                Averages Per 10min
              </h2>
              {averageList()}
            </div>
